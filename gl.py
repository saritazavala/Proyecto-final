...
class Renderer(object):
    ...
    #Cargar la ventana y los objetos dentro de ella
    def render(self):
        ...
        if self.active_shader:
            ...
            glUniformMatrix4fv(glGetUniformLocation(self.active_shader, "model"), 1, GL_FALSE, glm.value_ptr( self.modelList[self.active_model].getMatrix() ))
